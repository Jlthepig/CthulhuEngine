...
unsigned int ShadowMap::getDepthMap() const { return depthMap; }

glm::mat4 ShadowMap::getLightSpaceMatrix() const { return lightSpaceMatrix; }

Shader &ShadowMap::getDepthShader() { return depthShader; }
